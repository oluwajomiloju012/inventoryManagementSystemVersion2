...
productRouter.put('/:id',authorizeRoles('admin'),authorizeRoles('storekeeper'),updateProduct);
...
productRouter.post('/createproductwithemail',authorizeRoles('admin'),authorizeRoles('storekeeper'), createProductwithEmail);
